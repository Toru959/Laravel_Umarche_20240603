...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'shop_id' => 'required|exists:shops,id', // shopのidが存在しているか確認
            'category' => 'required|exists:secondary_categories,id', // categoryのidが存在しているか確認
            'image1' => 'nullable|exists:images,id', // imageがあった場合idが存在しているか確認する
