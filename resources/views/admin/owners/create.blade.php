                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class="-m-2">
                              ...
                              <div class="p-2 w-full mt-4 flex justify-around">
                                <button onclick="location.href='{{ route('admin.owners.index') }}'" class=" text-white bg-grey-200 border-0 py-2 px-8 focus:outline-none hover:bg-grey-200 rounded text-lg">戻る</button>
