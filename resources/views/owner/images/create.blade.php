                   ...
                   <form method="post" action="{{ route('owner.images.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="-m-2">
                        ...
                        <div class="p-2 w-full mt-4 flex justify-around">
                            <button type="button" onclick="location.href='{{ route('owner.images.index') }}'" class="bg-gray-200 text-black border-0 py-2 px-8 focus:outline-none hover:bg-grey-200 rounded text-lg">戻る</button>
