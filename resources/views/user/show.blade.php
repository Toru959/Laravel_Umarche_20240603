        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="md:flex md:justify-around">
                            ...
                            <div class="swiper-container">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    {{-- <div class="swiper-slide">
                                        <img src="{{ asset('storage/products/sample1.jpg') }}">
                                    </div>   
                                    <div class="swiper-slide">
                                        <img src="{{ asset('storage/products/sample2.jpg') }}">
                                    </div>   
                                    <div class="swiper-slide">
                                        <img src="{{ asset('storage/products/sample3.jpg') }}">
                                    </div>   
                                    <div class="swiper-slide">
                                        <img src="{{ asset('storage/products/sample4.jpg') }}">
                                    </div> --}}  
                        ...
                        <div class="md:w-1/2 ml-4">
                            ...
                            <div class="flex justify-around items-center">
                                <span class="title-font font-medium text-2xl text-gray-900 ml-6">{{ number_format($product->price) }}</span><span class="text-sm text-gray-700 ml-2">円(税込)</span>
                    ...
                    <div class="border-t border-gary-400 my-8">
                        ...
                        <div class="mb-4 text-center">
                            <button data-micromodal-trigger="modal-1" href='havascript:;' type="button" class="text-white bg-garay-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded">ショップの詳細を見る</button>
                        </div>
                    </div>
                </div>
            </div>
